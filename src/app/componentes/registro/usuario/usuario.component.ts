...
export class UsuarioComponent implements OnInit, OnDestroy
{
  ...
  //PAASRLO AL REGISTER MODULE
  /*setearPerfil(perfil:string)
  {
    this.perfil = perfil;
    this.deshabilitarFotoPerfil = false;
      this.minimoFotos = 1;
      if(perfil === "Paciente")
      {
        this.minimoFotos = 2;
        this.outPutPefilPaciente.emit(true);
      }
      else
      {
        this.outPutPefilEspecialista.emit(true);
      }
  }*/
